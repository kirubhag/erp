 ...
 * Loads student records from grade_*.xml and kindergarten.xml files into the
 * database.
 * 
...
public class StudentDataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        // Only initialize if table is empty - CHANGED: Removed to allow partial loading
        // Per-student check is already in place
        /*
