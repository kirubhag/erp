...
public interface ErpFieldRepository extends JpaRepository<ErpField, Long> {
     ...
     */
    @Query("SELECT ef FROM ErpField ef WHERE ef.entityType = :entityType AND ef.isActive = true ORDER BY ef.displayOrder ASC, ef.fieldLabel ASC")
     ...
     */
    @Query("SELECT ef FROM ErpField ef WHERE ef.entityType = :entityType AND ef.fieldCategory = :category AND ef.isActive = true ORDER BY ef.displayOrder ASC")
     ...
     */
    @Query("SELECT ef FROM ErpField ef WHERE ef.entityType = :entityType AND ef.isSearchable = true AND ef.isActive = true ORDER BY ef.displayOrder ASC")
     ...
     */
    @Query("SELECT ef FROM ErpField ef WHERE ef.entityType = :entityType AND ef.isSortable = true AND ef.isActive = true ORDER BY ef.displayOrder ASC")
     ...
     */
    @Query("SELECT ef FROM ErpField ef WHERE ef.entityType = :entityType AND ef.fieldName = :fieldName AND ef.isActive = true")
     ...
     */
    @Query("SELECT DISTINCT ef.fieldCategory FROM ErpField ef WHERE ef.entityType = :entityType AND ef.isActive = true AND ef.fieldCategory IS NOT NULL ORDER BY ef.fieldCategory")
     ...
     */
    @Query("SELECT COUNT(ef) FROM ErpField ef WHERE ef.entityType = :entityType AND ef.isActive = true")
