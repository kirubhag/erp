...
public interface UserSubscriptionRepository extends JpaRepository<UserSubscription, Long> {
    ...
    @Query("SELECT s FROM UserSubscription s WHERE s.userId = :userId AND s.organizationId = :organizationId " +
    ...
    @Query("SELECT s FROM UserSubscription s WHERE s.subscriptionStatus = 'TRIAL' " +
    ...
    @Query("SELECT s FROM UserSubscription s WHERE s.nextBillingDate = :date " +
