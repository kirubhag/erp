...
public class DataImportService {
    ...
    private void importParents(Document document) {
        NodeList parentNodes = document.getElementsByTagName("parents");
    ...
    private void importParentStudentRelations(Document document) {
        ...
        for (int i = 0; i < relationNodes.getLength(); i++) {
            ...
            relation.setRelationshipType(ParentStudentRelation.RelationshipType.valueOf(element.getAttribute("relationship_type")));
