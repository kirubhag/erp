...
public class Student extends BaseEntity {
    ...
    // Auto-generated by AutoNumberService - not required from frontend
    @Column(name = "student_identifier", unique = true, length = 20)
    ...
    // Date of birth is optional during creation, can be updated later
    ...
    // Enrollment date defaults to creation date if not provided
    ...
    public enum GradeLevel {
        ...
        GRADE_10("GRADE_10"), GRADE_11("GRADE_11"), GRADE_12("GRADE_12");
        ...
        public static GradeLevel fromValue(String value) {
            ...
            throw new IllegalArgumentException("Unknown grade level: " + value);
        }
    }
