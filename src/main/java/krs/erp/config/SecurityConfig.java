        ...
        http
                ...
                .csrf(csrf -> csrf
                        .ignoringRequestMatchers("/api/auth/**", "/settings/auth/**", "/webjars/**", "/actuator/**",
                                "/api/import/**", "/api/attachments/**", "/api/subscriptions/**",
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers("/api/attachments/**").permitAll() // Allow attachment endpoints (avatar
                                                                            // upload)
                        .requestMatchers("/api/subscriptions/**").permitAll() // Allow subscription/pricing endpoints
                                                                              // for public access
                        ...
                        .requestMatchers("/static/**", "/assets/**", "/css/**", "/js/**", "/images/**", "/vendor/**",
                                "/dist/**", "/angular/**")
                        .permitAll()
