...
-- XML files in src/main/resources/data/ directory via TenantProvisioningService.
-- Tenant databases receive data by copying from master database, which is
-- populated from XML sources:
-- - erp-entities.xml: Entity definitions
-- - Entity-specific XML files for sections and fields
--
-- This ensures consistency and maintains a single source of truth.
