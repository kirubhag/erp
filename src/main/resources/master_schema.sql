...
-- ============================================================================
-- All seed data including entities, sections, fields, and sample data are
-- populated from XML files in src/main/resources/data/ directory:
-- - erp-entities.xml: Entity definitions
-- - room/room_sections.xml, room/room_fields.xml: Room entity metadata
-- - timetable/timetable_sections.xml, timetable/timetable_fields.xml: Timetable metadata
-- - Other entity-specific XML files for sections and fields
--
-- This ensures a single source of truth and prevents inconsistencies between
-- SQL schema and XML data sources.
