...
CREATE TABLE student_promotion_record (
    ...
    promotion_status ENUM('SUCCESS', 'FAILED', 'ROLLED_BACK', 'PENDING') DEFAULT 'PENDING',
...
CREATE TABLE student_promotion_validation_rule (
    ...
    rule_type ENUM('GRADE_TRANSITION', 'ATTENDANCE_THRESHOLD', 'ACADEMIC_PERFORMANCE', 'CUSTOM') NOT NULL,
...
CREATE TABLE student_promotion_audit_log (
    ...
    batch_id BIGINT,
    record_id BIGINT,
    action_type ENUM('BATCH_CREATED', 'BATCH_STARTED', 'PROMOTION_SUCCESS', 'PROMOTION_FAILED', 'BATCH_COMPLETED', 'BATCH_ROLLED_BACK', 'VALIDATION_FAILED', 'SECTION_CHANGED') NOT NULL,
